...
# Silence SimConnect version warnings which clutter FSX output
logging.getLogger("SimConnect.SimConnect").setLevel(logging.CRITICAL)

print("VERSION: SERVER_V3_UNIQUE")
...
async def handler(websocket):
    ...
    if HAS_SIMCONNECT:
        try:
            ...
            # FSX often fails here or warns. We catch it.
        ...
        while True:
            ...
            if sm and aq:
                try:
                    ...
                    if lat is None: raise ValueError("No Data Received")
                    ...
                    # If read fails (common in FSX due to library mismatch), fallback immediately
